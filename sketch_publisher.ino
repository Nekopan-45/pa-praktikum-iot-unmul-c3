...
//   }
//   Serial.println();
//   int kontrol = ctrl.toInt();
//   // Switch on the LED if an 1 was received as first character
//   if (kontrol == 0) {
//     int NilaiPIR = 1;   // Turn the LED on (Note that LOW is the voltage level
//     // but actually the LED is on; this is because
//     // it is active low on the ESP-01)
//   } else {
//     int NilaiPIR = analogRead(PS_PIN); // Turn the LED off by making the voltage HIGH
//   }
...
void loop() {
  ...
  client.loop();
  int NilaiPIR = analogRead(PS_PIN);
  delay(5000);
